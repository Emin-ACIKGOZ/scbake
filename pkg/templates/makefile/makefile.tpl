...
.PHONY: all build clean help lint lint-fix test
...
help:
	...
	@echo "  test          : Runs tests using configured test command."
...
test:
	@echo "Running tests..."
	{{- if index .Metadata "test_command" }}
	{{ index .Metadata "test_command" }}
	{{- else }}
	go test ./...
	{{- end }}
